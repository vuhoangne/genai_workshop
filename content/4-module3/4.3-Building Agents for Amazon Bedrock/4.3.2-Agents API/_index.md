...
![api.png](/images/4-module3/api.png)

3. 🍔 Click the Hamburger Menu in the top left corner.
4. 💻 Navigate to Terminal -> New Terminal.
5. ▶️ Run the code with `python3 rag_examples/agent_rag.py`.
6. ✍️ Try playing with `QUERY` on line 6 to see what type of responses you get.

![api1.png](/images/4-module3/api1.png)